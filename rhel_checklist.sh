...
# 5. Ensure the user 'rhel' exists
echo "Checking if the user 'rhel' exists..."
if sudo id -u rhel >/dev/null 2>&1; then
    echo -e "User 'rhel' exists ..... ${GREEN}OK${NC}"
else
    echo -e "User 'rhel' exists ..... ${RED}NO${NC}"
fi
